...
function RingCard({ children, title }) {
  return (
    <div className='relative mt-20 text-white text-lg items-center bg-red-700 rounded-lg shadow-2xl shadow-black border-2 border-yellow-400 mb-2 ml-16 p-4 pt-16'>
